...
export const CHALLENGE_BG_COLOR = {
  red: 'bg-red-300',
  green: 'bg-green-300',
  blue: 'bg-blue-300',
...
export const CHALLENGE_200_BG_COLOR = {
  red: 'bg-red-200',
  green: 'bg-green-200',
  blue: 'bg-blue-200',
...
export const CHALLENGE_300_BG_COLOR = {
  red: 'bg-red-300',
  green: 'bg-green-300',
  blue: 'bg-blue-300',
  indigo: 'bg-indigo-300',
...
export const CHALLENGE_400_BG_COLOR = {
  red: 'bg-red-400',
  green: 'bg-green-400',
  blue: 'bg-blue-400',
...
export const CHALLENGE_BG_500_COLOR = {
  red: 'bg-red-500',
  green: 'bg-green-500',
  blue: 'bg-blue-500',
...
export const CHALLENGE_FOCUS_BG_300_COLOR = {
  ...
  blue: 'focus:bg-blue-300',
  indigo: 'focus:bg-indigo-300',
  teal: 'focus:bg-teal-300',
  yellow: 'focus:bg-yellow-300',
  purple: 'focus:bg-purple-300',
  pink: 'focus:bg-pink-300',
} as const;

export const CHALLENGE_ACTIVE_BG_200_COLOR = {
...
export const CHALLENGE_ACTIVE_BG_500_COLOR = {
  red: 'active:bg-red-500',
  green: 'active:bg-green-500',
  blue: 'active:bg-blue-500',
  indigo: 'active:bg-indigo-500',
  teal: 'active:bg-teal-500',
  yellow: 'active:bg-yellow-500',
...
export const CHALLENGE_TEXT_COLOR_300 = {
  red: 'text-red-300',
...
export const CHALLENGE_TEXT_COLOR_200 = {
  red: 'text-red-200',
...
export const CHALLENGE_BORDER_COLOR_400 = {
  red: 'border-red-400',
...
export const CHALLENGE_ACTIVE_TEXT_COLOR_400 = {
  red: 'active:text-red-400',
  green: 'active:text-green-400',
  blue: 'active:text-blue-400',
  indigo: 'active:text-indigo-400',
  teal: 'active:text-teal-400',
  yellow: 'active:text-yellow-400',
  purple: 'active:text-purple-400',
  pink: 'active:text-pink-400',
} as const;
